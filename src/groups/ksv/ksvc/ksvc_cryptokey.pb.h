...
#ifndef PROTOBUF_INCLUDED_ksvc_5fcryptokey_2eproto
#define PROTOBUF_INCLUDED_ksvc_5fcryptokey_2eproto
...
class CryptoKey final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:MvdS.ksvc.CryptoKey) */ {
 public:
  CryptoKey();
  virtual ~CryptoKey();
...
inline void CryptoKey::set_allocated_primary(::MvdS::ksvc::CryptoKeyVersion* primary) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(primary_);
  }
  if (primary) {
...
inline void CryptoKey::set_allocated_versiontemplate(::MvdS::ksvc::CryptoKeyVersionTemplate* versiontemplate) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(versiontemplate_);
  }
  if (versiontemplate) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      versiontemplate = ::google::protobuf::internal::GetOwnedMessage(
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_ksvc_5fcryptokey_2eproto
